import {
    ...
    Img,
    Preview,
    Markdown, Text, Button,} from "@react-email/components";
...
export const text = {
    heading: 'Katılımını Bekliyoruz!',
    info: `%%surveyname%% **bugün** kapanıyor!!!`,
    button: 'Ankete Başla',
    survey_description: 'Fikirlerin ve düşüncelerin bizim için çok değerli, anketimiz yarın sonlanmadan katılımını bekliyoruz!',
    description: `Düşüncelerini **%100 anonim** olarak paylaşman için son şans!`,
}
